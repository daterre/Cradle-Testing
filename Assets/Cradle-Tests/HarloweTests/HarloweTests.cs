...
public partial class @HarloweTests: Cradle.StoryFormats.Harlowe.HarloweStory
{
	...
	IStoryThread passage16_Main()
	{
		...
		Vars.name = "Doron";
		yield return link("Hi " + Vars.name + "! What's up?", "Result", null);
		macros2.assertLink("Hi Doron! What's up?","Result");
